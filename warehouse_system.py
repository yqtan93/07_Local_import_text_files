...
from warehouse_class import Manager
...
# Print list of command upon launching, display function of each command before each command prompt
    ...
    - 'inventory': To check the total inventory in the warehouse (Product name, price, quantity)
    - 'product': To check a product name and its status in the warehouse.
...
# Ask user to input a command
    ...
    if action == "sale":
        manager.execute("sale", curr_balance, stock, history)
    elif action == "purchase":
        manager.execute("purchase", curr_balance, stock, history)
    elif action == "inventory":
        manager.execute("inventory", stock)
    elif action == "balance":
        manager.execute("balance", curr_balance, history)
    elif action == "account":
        manager.execute("account", curr_balance)
    elif action == "product":
        manager.execute("product", stock)
    elif action == "review":
        manager.execute("review", history)
    elif action == "end":
        manager.execute("end", curr_balance, stock, history)
        break
